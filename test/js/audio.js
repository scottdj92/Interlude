...
/** CONSTANTS **/
var FFTSIZE = 32; //number of samples for Fourier Transform
var TICK_FREQ = 20; //how often to run tick, in ms
var CIRCLES = 8; //number of circles to draw. this is also the amount to break the files into. so FFTSIZE/2 has to be even.
var RADIUS_FACTOR = 40; //radius of circles
var MIN_RADIUS = 1; //minumum radii
var HUE_VARIANCE = 120; //hue variance
var COLOR_CHANGE_THRESHOLD = 15; //amount of change before we effect change
var WAVE_EMIT_THRESHOLD = 15; //amount of positive change before we effect change
var WAVE_SCALE = 0.03; //amount to scale wave per tick
var WAVE_RADIUS = 180; //waves will be drawn with this radius.
...
var circles = {}; //object has of circle shapes
var circleHue = 300; //base color hue
//var waves = new createjs.Container(); //container used to store waves when we draw them
var circleFreqChunk; //chunk of freqByteData array that is computed per circle
